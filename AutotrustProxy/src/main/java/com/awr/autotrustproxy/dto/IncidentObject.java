...
public class IncidentObject {
    ...
    private String incicdentTypeId;
    ...
    public void setIncicdentTypeId(String incicdentTypeId) {
        this.incicdentTypeId = incicdentTypeId;
    }

    public String getIncicdentTypeId() {
        return incicdentTypeId;
    }
