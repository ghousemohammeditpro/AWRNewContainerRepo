...
public class SaveSubscriptionUtil {
    public SaveSubscriptionUtil() {
        super();
    }
    public static String saveSubscription(SaveSubscriptionRequest req, String source) {
        ...
        String soapAction = propUtil.getPropertyValue("SAVE_SUBSCRIPTION_ACTION");
    ...
    private static String callSoapWebService(String soapEndpointUrl, String soapAction, SaveSubscriptionRequest req, String source) {
        String retVal = null;
        try {
            ...
            SOAPMessage soapResponse = soapConnection.call(createSOAPRequest(soapAction, req, source), soapEndpointUrl);
                    ...
                    NodeList nodes = soapBody.getElementsByTagName("saveSubscriptionResult");
    ...
    private static void createSoapEnvelope(SOAPMessage soapMessage,SaveSubscriptionRequest req, String source) throws SOAPException {
           ...
           SOAPElement soapBodyElem = soapBody.addChildElement("saveSubscription", myNamespace);
           SOAPElement soapBodyElem1 = soapBodyElem.addChildElement("buId", myNamespace);
           soapBodyElem1.addTextNode(req.getBuId());
           SOAPElement soapBodyElem2 = soapBodyElem.addChildElement("check", myNamespace);
           soapBodyElem2.addTextNode(req.getCheck());
           SOAPElement soapBodyElem3 = soapBodyElem.addChildElement("source", myNamespace);
           soapBodyElem3.addTextNode(source);
      
       }
    
    private static SOAPMessage createSOAPRequest(String soapAction, SaveSubscriptionRequest req, String source) throws Exception {
