...
import com.awr.autotrustservice.dto.LeadContactPoints;

import com.awr.autotrustservice.dto.LeadExistingVehicles;
import com.awr.autotrustservice.dto.LeadInterestedVehicles;
import com.awr.autotrustservice.dto.LeadTradeInVehicles;
...
public class InsertLeadRequest {
    ...
    private LeadContactPoints[] contact_points;
    ...
    private String age; //Number
    private String nationality;
    private String profession;
    private String industry_type;
    private String family_size; //Number
    ...
    private String no_of_vehicles_interested; //Number
    private LeadInterestedVehicles[] interested_vehicles;
    private String existing_customer;
    private String existing_brand;
    private String existing_model;
    private String existing_model_age; //Number
    private String no_of_existing_vehicles; //Number
    private LeadExistingVehicles[] existing_vehicles;
    private String customer_comments;
    private String source_comments;
    private String lead_status;
    private String lead_status_date; //Date
    ...
    private String email_optin_date; //Date
    private String lattitude; //Number
    private String longitude; //Number
    ...
    private String trade_in_model_year; //Number
    private String trade_in_mileage; //Number
    private String trade_in_expected_amt; //Number
    private String no_of_tradein_vehicles; //Number
    private LeadTradeInVehicles[] tradein_vehicles;
    ...
    public void setContact_points(LeadContactPoints[] contact_points) {
        this.contact_points = contact_points;
    }

    public LeadContactPoints[] getContact_points() {
    ...
    public void setInterested_vehicles(LeadInterestedVehicles[] interested_vehicles) {
        this.interested_vehicles = interested_vehicles;
    }

    public LeadInterestedVehicles[] getInterested_vehicles() {
    ...
    public void setExisting_vehicles(LeadExistingVehicles[] existing_vehicles) {
        this.existing_vehicles = existing_vehicles;
    }

    public LeadExistingVehicles[] getExisting_vehicles() {
    ...
    public void setTradein_vehicles(LeadTradeInVehicles[] tradein_vehicles) {
        this.tradein_vehicles = tradein_vehicles;
    }

    public LeadTradeInVehicles[] getTradein_vehicles() {
