...
public class LoginUtil {
    ...
    public static String callLogin(LoginRequest req, String source) {
    ...
    private static String callSoapWebService(String soapEndpointUrl, String soapAction, LoginRequest req, String source) {
        String retVal = null;
        try {
            ...
            SOAPMessage soapResponse = soapConnection.call(createSOAPRequest(soapAction, req, source), soapEndpointUrl);
                    ...
                    NodeList nodes = soapBody.getElementsByTagName("loginDetailedResult");
    ...
    private static void createSoapEnvelope(SOAPMessage soapMessage,LoginRequest req, String source) throws SOAPException {
           ...
           SOAPElement soapBodyElem = soapBody.addChildElement("loginDetailed", myNamespace);
           ...
           SOAPElement soapBodyElem3 = soapBodyElem.addChildElement("isFBLogin", myNamespace);
           soapBodyElem3.addTextNode(req.getIsFBLogin());
           SOAPElement soapBodyElem4 = soapBodyElem.addChildElement("source", myNamespace);
           soapBodyElem4.addTextNode(source);
      
       }
    
    private static SOAPMessage createSOAPRequest(String soapAction, LoginRequest req, String source) throws Exception {
