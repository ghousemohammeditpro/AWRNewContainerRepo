...
public class LoadPersonalDetailsUtil {
    public LoadPersonalDetailsUtil() {
        super();
    }
    public static String personalDetails(GenericRequest req, String source) {
        ...
        String soapAction = propUtil.getPropertyValue("PERSONAL_DETAILS_ACTION");
    ...
    private static String callSoapWebService(String soapEndpointUrl, String soapAction, GenericRequest req, String source) {
        String retVal = null;
        try {
            ...
            SOAPMessage soapResponse = soapConnection.call(createSOAPRequest(soapAction, req, source), soapEndpointUrl);
                    ...
                    NodeList nodes = soapBody.getElementsByTagName("loadMyPersonalDetailsResult");
    ...
    private static void createSoapEnvelope(SOAPMessage soapMessage,GenericRequest req, String source) throws SOAPException {
           ...
           SOAPElement soapBodyElem = soapBody.addChildElement("loadMyPersonalDetails", myNamespace);
    ...
    private static SOAPMessage createSOAPRequest(String soapAction, GenericRequest req, String source) throws Exception {
