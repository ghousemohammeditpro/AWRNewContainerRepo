...
public class TxnDetailsObject {
    public TxnDetailsObject() {
        super();
    }
    ...
    public void setCustAccountCode(String custAccountCode) {
        this.custAccountCode = custAccountCode;
    }

    public String getCustAccountCode() {
        return custAccountCode;
    }
