...
import com.awr.autotrustservice.request.CreateSFLeadRequestV1;
...
//                utility.callAudit("vehicles", "createLead", generatedSourceLeadId);
                ...
                stmt.setNull(68, Types.VARCHAR); //p_tc_optin
                stmt.setNull(69, Types.DATE); //p_tc_optin_date
                //stmt.setString(70, req.getOptIn()); //p_all_optin
                if(req.getOptIn()!=null){
                    stmt.setString(70, req.getOptIn());
                }else{
                ...
                if(req.getAttribute2()!=null){
                    stmt.setString(87, req.getAttribute2());
                }else{
                    stmt.setNull(87, Types.VARCHAR); 
                }
                if(req.getAttribute3()!=null){
                    stmt.setString(88, req.getAttribute3());
                }else{
                    stmt.setNull(88, Types.VARCHAR); 
                }
                if(req.getAttribute4()!=null){
                    stmt.setString(89, req.getAttribute4());
                }else{
                    stmt.setNull(89, Types.VARCHAR); 
                }
                if(req.getAttribute5()!=null){
                    stmt.setString(90, req.getAttribute5());
                }else{
